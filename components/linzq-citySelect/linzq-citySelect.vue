<template>
	<div class="wrapper" :style="'top:'+statusBarHeight+'px'">
		<div class="header">
			<view class="back_div">
				<image class="back_img" @click="back_city()" src="/static/icon//left.svg" mode=""></image>
			</view>
			...
			<view v-if="disdingwei" id="hot">
				...
				<view class="dingwei">
					...
					<view class="dingwei_city">
						...
						<view class="dingweis_div" @click="getWarpweft">
							<image class="dingweis" src="/static/icon/location.svg" mode=""></image>
							<text>{{po_tips}}</text>
						</view>
					</view>
				</view>
				...
				<view class="dingwei" v-if="Visit.length>=0">
					...
					<view class="dingwei_city dingwei_city_zuijin">
						<view class="dingwei_city_one toright" v-for="(item,index) in Visit" v-show="index<2" @click="back_city(item)">
							{{item.cityName}}
						</view> 
					</view>
				</view>
