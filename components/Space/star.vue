<template>
  <h2 style="margin-top: 50px;">Star - test</h2>
  ...
  <view class="flex-center-horizontal btn-test">
    <hv-btn @click="reload">更新</hv-btn>
    <hv-btn @click="back">返回</hv-btn>
  </view>
  <view>
    <h3>History</h3>
    <view v-for="item in pathHistory">
      {{ item }}
    </view>
  </view>
</template>
...
// DATA
  ...
  const nameList = ref([
    // 添加更多的星球标签和它们的值
    { wordName: 'Star1-1', wordValue: 1000 },
    { wordName: 'Star1-2', wordValue: 600 },
    { wordName: 'Star1-3', wordValue: 600 },
    { wordName: 'Star1-4', wordValue: 600 },
    { wordName: 'Star1-5', wordValue: 600 },
    { wordName: 'Star1-6', wordValue: 600 },
    { wordName: 'Star1-7', wordValue: 600 },
    { wordName: 'Star1-8', wordValue: 600 },
    { wordName: 'Star1-9', wordValue: 600 },
    { wordName: 'Star1-10', wordValue: 600 },
    { wordName: 'Star1-11', wordValue: 600 },
    { wordName: 'Star1-12', wordValue: 600 },
    { wordName: 'Star1-13', wordValue: 600 },
    { wordName: 'Star1-14', wordValue: 600 },
    { wordName: 'Star1-16', wordValue: 600 },
    { wordName: 'Star1-16', wordValue: 600 },
    { wordName: 'Star1-17', wordValue: 600 },
    { wordName: 'Star1-18', wordValue: 600 },
    { wordName: 'Star1-19', wordValue: 600 },
    { wordName: 'Star1-20', wordValue: 600 },
    // ... 其他标签
  ]);
  let tags = [];
